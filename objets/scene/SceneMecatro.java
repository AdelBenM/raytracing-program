...
import objets.objetMecatro.MiroirPlanConvexe;
...
public class SceneMecatro extends SceneSansSources {
	...
	public SceneMecatro() {
		this(new CouleurL(Color.WHITE, 1000));
		}
	...
	public static void main(String[] args) {
		...
		MiroirPlanConvexe mir1 = new MiroirRectangle("Miroir 1" ,R3.ux, Point3.origine.moins(R3.ux.prod(5)),10,10);
		scene.ajouter(mir1);
