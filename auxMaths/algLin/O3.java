...
public class O3 extends GL3{
	...
	/**Applique une permutation circulaire vers la droite de nbFois colonnes.
	 * hypothèse : nbFois positif
	 * @param nbFois
	 * @return
	 */
	public O3 permutationColonnes(int nbFois) {
		if (nbFois<0)
			throw new IllegalArgumentException("nb negatif interdit");
		else {
			switch(nbFois%3) {
			case 0: return new O3(this,true);
			case 1: return new O3(new M3(v3,v1,v2));
			case 2: return new O3(new M3(v2,v3,v1));
			default: return null;
			}
		}
	}
