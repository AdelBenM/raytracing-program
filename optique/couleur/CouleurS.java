...
public class CouleurS implements Serializable{
	...
	//TODO : y réfléchir physiquement
	public CouleurL getResultante(CouleurL lum) {
		if (r==0 && g==0 && b==0)
			return CouleurL.noir;
		else {
			Color resultante = new Color(r*lum.getProportionR(),g*lum.getProportionG(),b*lum.getProportionB());
			CouleurL c = new CouleurL(resultante, lum.getIntensite());
			return c;
		}
	}
