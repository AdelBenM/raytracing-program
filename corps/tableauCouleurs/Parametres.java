...
public class Parametres implements Serializable{
  ...
  /**Jamais directement modifiÃ©; rapport des dimensions du cadre "virtuel" par celles de l'image finale
   * 
   */
  ...
  /**Renvoie le nombre de réflexions sur des surfaces pris en compte dans les calculs du modèle de Phong.
   * 
   * @return
   */
