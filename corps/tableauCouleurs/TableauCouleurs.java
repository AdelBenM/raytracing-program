...
public class TableauCouleurs{
	...
	protected double intBlanc;	//L'intensité de la lumière à partir de laquelle la couleur du rendu est saturée ; editable à souhait.
	
	protected double intMax;		//L'intensité max d'une lumière dans contenu
